...
us = np.array([88, 92, 95, 97, 99, 100, 102, 104, 107, 110, 95, 108, 114, 118, 122, 125])
...
highlight_panel(ax, 2019.7, 2020.8, label="Pandemic")
...
highlight_label(ax, xy=(2024, eu[-2]), text="Forecast", role="secondary")
